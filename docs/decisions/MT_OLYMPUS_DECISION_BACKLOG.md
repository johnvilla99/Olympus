...
| OLY-DB-018 | Should Olympus pursue **Project Intelligence** as an external or commercial product positioning? | Product | Open | ACR-003 and RNO-003 support exploration only. Do not promote the phrase into approved positioning without customer evidence and Founder review. |
| OLY-DB-019 | What differentiated customer promise should Olympus lead with? | Product | Open | Current strongest hypothesis is governed memory plus authority-aware judgment, not generic search, documentation automation, or engineering metrics. Requires validation. |
| OLY-DB-020 | What belongs in reusable **Olympus Core** versus a project-specific instance? | Product / Architecture | Open | Product boundary may be explored in Phase 2; implementation mapping remains deferred to architecture phases. |
...
| Active repository location | Which repository is durable? | Resolved: `johnvilla99/Olympus` | GDR-009 (supersedes GDR-007) |
...
ACR-003 and RNO-003 are current Phase 2 exploratory inputs. They do not close OLY-DB-018 through OLY-DB-020 and do not constitute approved market positioning, MVP scope, commercialization, architecture, or implementation authority.

The strongest current product hypothesis is that Olympus may differentiate through **governed memory and authority-aware judgment**: understanding what is authoritative, what conflicts, what changed, what prior experience applies, and what human decision is required. This remains subject to Product Gate evidence and Founder approval.
...
- Use [[GDR-009_CANONICAL_REPOSITORY_LOCATION|GDR-009]] for the active durable repository.
- Treat ACR-003 and RNO-003 as exploratory evidence, not approved product direction.
