...
- Do not create application, architecture, schema, API, UI, or vendor-selection artifacts unless the phase and task explicitly authorize them.
...
| Repository location | `docs/decisions/GDR-007_CANONICAL_REPOSITORY_LOCATION.md` |
